...
import rv.actor.EvilShopkeeperRobot;
...
public class Game implements GameInterface, KeyListener, MouseListener, ContactListener{
	...
	public void render() {
		...
		if(objectiveScreen)
		{
			...
			switch(plot)
			{
				case 0: text = "Talk to the mayor. His house is in the center bottom of town."; break;
				case 1: text = "Talk to the technician. His house is just west of the mayor's."; break;
				case 2: text = "Search the cave to the west of town for the leader."; break;
				case 3: text = "Return the core to the technician."; break;
				case 4: text = "Search the cave to the east of town for something transmitting."; break;
				case 5: text = "Return to town and find who was transmitting."; break;
				case 6: text = "Defeat the evil shopkeeper."; break;
				case 7: text = "Bask in your glory!"; break;
			}
		...
		if(inventoryScreen)
		{
			...
			for(int i=0;i<player.getInventory().length;i++)
			{
				if(itemSelected == i) SGF.getInstance().renderImage("invselected", getInvItemX(i), getInvItemY(i), 48, 48, 0, false);
			}
		...
		if(inventoryScreen)
		{
			for(int i=0;i<player.getInventory().length;i++)
			{
				if(player.getInventory()[i] == null) continue;
	...
	public void playAudio(String name)
	{
		...
		//RobotVillage.s.getAudioClip(RobotVillage.s.getDocumentBase(), "./media/" + name + ".wav").play();
	...
	public void update() {
		if(!inventoryScreen)
		{
			...
			{
				if(actors.get(i) instanceof Dialog) dialogTemp = true;
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == KeyEvent.VK_I) inventoryScreen = !inventoryScreen;
		if(e.getKeyCode() == KeyEvent.VK_O) objectiveScreen = !objectiveScreen;
		if(e.getKeyCode() == KeyEvent.VK_F1) helpScreenUp = !helpScreenUp;
	}
	...
	public void add(ContactPoint point) {
		...
		if(o1 != null && o1 instanceof ContactListener) ((ContactListener)o1).add(point);
		if(o2 != null && o2 instanceof ContactListener) ((ContactListener)o2).add(point);
	}
	...
	public void result(ContactResult point) {
		...
		if(o1 != null && o1 instanceof ContactListener) ((ContactListener)o1).result(point);
		if(o2 != null && o2 instanceof ContactListener) ((ContactListener)o2).result(point);
	}
